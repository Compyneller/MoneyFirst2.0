...
const TermAndCondition = () => {
  return (
    <div style={{ width: "50%", margin: "0 auto", padding: "5rem 0" }}>
      ...
      <h5>1.2</h5>
      <p>
        The term "you" or "your" refers to any user of the Service, in the
        capacity of a Customer, Sender, Recipient, or Visitor of the
        Application.
      </p>
      <h5>1.3</h5>
      <p>
        These Terms and Conditions are effective as of the date first written.
        The Terms and Conditions may change from time to time, but any change
        will only be effective from the date it is made and will not change the
      ...
      <h5>1.5</h5>
      <p>
        By using the Service you authorize us to access all information relating
        to you (including personal information relating to access and use of the
        Application by you and the transactions performed by you) in accordance
      ...
      <h5>3.2</h5>
      <p>You shall not create more than one Registered User ID.</p>
      <h5>3.3</h5>
      <p>
        You will provide true, accurate, current and complete information
        concerning your identity and promptly update this information to keep it
        true, accurate, current and complete if it changes.
      </p>
      <h5>3.4</h5>
      <p>
        We may terminate your registration and refuse access to and use of the
        Application or Service, including the cancellation of pending
        transactions, if we reasonably believe that you provided information
        that is untrue, inaccurate, not current or incomplete or that you are
        using the Service in breach of these Terms and Conditions or any
        applicable laws, rules or regulations.
      </p>
      <h5>3.5</h5>
      <p>
        We may request from you, at any time and from time to time, additional
        information and/or proof of authenticity of any information previously
        provided; your continued access to the Application and the Service,
        including the completion of any ongoing transaction, may be subject to
        the receipt by us of such additional information or proof.
      </p>
      <h5>3.6</h5>
      <p>
        You will be solely and absolutely responsible for maintaining the
        secrecy and confidentiality of your Registered User ID including
        personal identification numbers.
      </p>
      <h5>3.7</h5>
      <p>
        You are solely and absolutely responsible and liable for all
        Transactions and activities that occur using your Registered User ID
        including any unauthorized use or misuse of the Registered User ID and
        Moneyfirst will have no obligation to verify the authenticity of any
        such Transaction or activity.
      </p>
      <h5>3.8</h5>
      <p>
        You will unconditionally indemnify us and hold us harmless against any
        liability, costs, damages, claims, suits, and proceedings based upon or
        relating to any unauthorized access and/or use of your Registered User
        ID.
      </p>
      <h5>3.9</h5>
      <p>
      ...
      <h5>3.10</h5>
      <p>
        To the extent permissible by applicable law, we shall have the right
        (but not the obligation) to require the Customer/User to communicate
        instructions and authorize and execute Transactions and other activities
        by means of secure electronic records and secure digital signatures in
      ...
      <p>
        ...
        Service, you authorize Moneyfirst and Supplier to access third party
        internet sites, servers or documents, retrieve information, and use your
        information, with the full power and authority to do and perform each
        and every act and thing requisite and necessary to be done in connection
        with the verification. YOU ACKNOWLEDGE AND AGREE THAT WHEN MONEYFIRST OR
        SUPPLIER ACCESSES AND RETRIEVES INFORMATION FROM THIRD PARTY SITES,
        MONEYIRST AND SUPPLIER ARE ACTING AS YOUR AGENT, AND NOT THE AGENT OR ON
        BEHALF OF THE THIRD PARTY. You agree that third party account
        verification providers shall be entitled to rely on the foregoing
        authorization.
      </p>
      <h5>4.2</h5>
      <p>
        The Challenge Deposit Verification Service is an alternate method of
        verifying your access to an external Payment Account. By using the
        Challenge Deposit Verification Service, you authorize Moneyfirst and
        Supplier to make up to one micro value transactions to the Payment
        Account specified by you. You will thereafter verify to Moneyfirst
        and/or Supplier the amounts deposited to the Payment Account.
      </p>
      <h5>4.3</h5>
      <p>
        You agree that the results of the verification service are for use by
      ...
      <p>
        ...
        or Service of the Application. Moneyfirst may advise you of any such
        changes by sending you an Alert or by notification on the Application.
      </p>
      <h5>5.2</h5>
      <p>
        You are responsible for obtaining, maintaining and ensuring
        compatibility of your own equipment when using the Application.
        Moneyfirst will not be responsible for any loss of or damage to your
        data, software, computer, telecommunications or other equipment caused
        by your use of the Application. You are responsible for ensuring that
        your equipment is free from viruses and other malware. Moneyfirst will
        not be responsible for any losses incurred by your failure to do this.
      </p>
      <h5>5.3</h5>
      <p>
        ...
        indirect or consequential) which may be suffered by you or incurred by
        you arising from or in any way connected with any interruption or
      ...
      <p>
        You will provide true, accurate, current and complete information
        regarding the Beneficiary/Receiver for all Transactions.
      </p>
      <h5>6.4</h5>
      <p>
      ...
      <h5>6.5</h5>
      <p>
        When you pay for a Transaction in one currency and the Receiver is paid
        in another currency, there will be a difference between the exchange
        rate at which we buy foreign currency and the exchange rate provided to
        you. We and our Service Providers may have a profit or loss in these
        ...
        by you, the amount received by the Receiver will be reduced by the
      ...
      <p>
        ...
        goods or services and that any such use of the Service is entirely at
        your own risk. If we reasonably believe you are using the Service to
        purchase goods or services, we reserve the right to cancel your
        transaction(s).
      </p>
      <h5>6.9</h5>
      <p>
      ...
      <h5>6.12</h5>
      <p>
        We may, as is necessary to provide the Service, store all information
        required of a Receiver to prove his or her identity or associated with
        the Receiver's specific Transaction. Such proofs may include, but are
        not limited to, a suitable form of valid, unexpired identification from
        a list of acceptable documents provided by the Service Provider, and/or
        a transaction tracking number, a personal identification number (PIN), a
        "password," a "secret word" or other similar identifiers as we or our
        Service Provider may deem fit.
      </p>
      <h5>6.13</h5>
      <p>
        In case we do not receive the Transaction Amount and fee/charges, and
      ...
      <h5>6.14</h5>
      <p>
        The Service Provider may credit/payout the Transaction Amount only after
      ...
      <p>
        ...
        using reasonable care. The Service may not be available in whole or in
        part in certain regions, countries, or jurisdictions.
      </p>
      <h5>7.2</h5>
      <p>
        We are not obliged to process any particular Transaction. When you
        submit a Transaction, you are requesting that we process the Transaction
        on your behalf. We may, in our sole discretion, choose whether or not to
        accept the offer to process that Transaction. However, if we decide not
        to process the Transaction, we will notify you promptly of that decision
        and repay the money paid to us.
      </p>
      <h5>7.3</h5>
      <p>
